...
export default function PaginationButtonLeft(props: PaginationRightButtonProps) {
  ...
  const btnStyling = `ring-1 ring-white-900 text-white bg-transparent hover:bg-white-300 focus:outline-none focus:ring-4 focus:ring-white-800 font-medium rounded-full text-sm p-0 text-center me-0 mb-0 focus:p-[1px] p-[.5px] dark:bg-white-600 dark:hover:bg-white-700 dark:focus:ring-white-800`
  if (disabled) {
    return (
...
export function PaginationButtonLeft(props: PaginationLeftButtonProps) {
  const [disabled, SetDisabled] = useState<boolean>(trueA);
  const init = () => {
